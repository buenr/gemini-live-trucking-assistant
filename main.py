...
async def driver_data():
    snapshot = get_driver_snapshot()
    hours = get_hours_compliance_summary()
    hometime = get_hometime_status()
    return {
        "success": True,
        "driver": snapshot.get("driver", {}),
        "route": snapshot.get("route", {}),
        "hours": {"drive_hours_left": hours.get("drive_hours_left")},
        "hometime": hometime.get("request") if hometime.get("success") else None,
    }
